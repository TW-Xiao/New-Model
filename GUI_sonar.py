...
class MainUi(QtWidgets.QMainWindow, QWidget):
    ...
    def init_ui(self):
        ...
        self.main_widget.setStyleSheet('''QWidget{border-radius:7px;background-color:rgb(64,64,64);}''')


        self.left_button_1 = QtWidgets.QPushButton( "加载权重")
        self.left_button_1.setObjectName('left_button')
        self.left_button_1.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        c = self.left_button_1
        c.clicked.connect(self.start_image2)
        c.clicked.connect(self.load_model)

        self.left_button_2 = QtWidgets.QPushButton("打开文件")
        self.left_button_2.setObjectName('left_button')
        self.left_button_2.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        b = self.left_button_2
        b.clicked.connect(self.openimage)

        self.left_button_3 = QtWidgets.QPushButton("上一张")
        self.left_button_3.setObjectName('left_button')
        self.left_button_3.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        a = self.left_button_3
        a.clicked.connect(self.backimage)

        self.left_button_4 = QtWidgets.QPushButton("下一张")
        self.left_button_4.setObjectName('left_button')
        self.left_button_4.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        e = self.left_button_4
        e.clicked.connect(self.nextimage)

        self.left_button_5 = QtWidgets.QPushButton("图像检测")
        self.left_button_5.setObjectName('left_button')
        self.left_button_5.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        f = self.left_button_5
        f.clicked.connect(self.detectimage)

        self.left_button5_5 = QtWidgets.QPushButton("图像另存")
        self.left_button5_5.setObjectName('left_button')
        self.left_button5_5.setStyleSheet("QPushButton{font-family:'黑体';font-size:30px;color:black;}\
                QPushButton{background-color:rgb(224,224,224)}\ QPushButton:hover{background-color:rgb(50, 170, 200)}")
        n = self.left_button5_5
        n.clicked.connect(self.saveimage)
        ...
        self.left_layout.addWidget(self.left_button5_5, 5, 0, 1, 3)


        # self.label_b1 = QLabel(self)
        # self.label_b1.setFixedSize(80, 40)
        # self.label_b1.move(45, 110)
        # self.label_b1.setStyleSheet("QLabel{background-color:blue;}"
        #                           "QLabel{color:blue;font-size:10px;font-weight:bold;font-family:黑体;}"
        #                           )
        ...
        self.wenben.setGeometry(510, 40, 560, 60)
        self.wenben.setStyleSheet("QLabel{background:rgb(224,224,224);}"
