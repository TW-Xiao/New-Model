...
class MainUi(QtWidgets.QMainWindow, QWidget):
    ...
    def init_ui(self):
        ...
        self.left_button_4 = QtWidgets.QPushButton("图片另存")
        ...
        # self.left_button6_5 = QtWidgets.QPushButton("负相变换")
        # self.left_button6_5.setObjectName('left_button')
        # s = self.left_button6_5
        # s.clicked.connect(self.fuxiang)
        ...
        self.left_layout.addWidget(self.left_button5_5, 7, 0, 1, 3)
        ...
        self.pbar.setStyleSheet(
            "QProgressBar {border: 2px solid grey; border-radius: 5px;   background-color: black;}QProgressBar::chunk {   background-color: grey;   width: 10px;}QProgressBar {   border: 2px solid grey;   border-radius: 5px;   text-align: center;}")
        ...
        self.label5.setFixedSize(420, 550)
        self.label5.move(1100, 170)

        self.label6 = QLabel(self)
        self.label6.setFixedSize(300, 270)
        self.label6.move(160, 160)

        self.label2.setStyleSheet("QLabel{background-color:rgb(57,57,57);}"
                                 "QLabel{color:rgb(300,300,300,120);font-size:10px;font-weight:bold;font-family:宋体;}"
                                 )
        self.label.setStyleSheet("QLabel{background-color:rgb(57,57,57);}"
                                 "QLabel{color:rgb(300,300,300,120);font-size:10px;font-weight:bold;font-family:宋体;}"
                                 )
        self.label4.setStyleSheet("QLabel{background-color:rgb(50,50,50);}"
                                 "QLabel{color:rgb(300,300,300,120);font-size:10px;font-weight:bold;font-family:宋体;}"
                                 )
        self.label5.setStyleSheet("QLabel{background-color:rgb(74,74,74);}"
                                  "QLabel{color:rgb(300,300,300,120);font-size:10px;font-weight:bold;font-family:宋体;}"
                                  )
        self.label6.setStyleSheet("QLabel{background-color:rgb(57,57,57);}"
                                  "QLabel{color:rgb(300,300,300,120);font-size:10px;font-weight:bold;font-family:宋体;}"
                                  )
        ...
        self.left_close.setStyleSheet(
            '''QPushButton{background:#6DDF6D;border-radius:20px;}QPushButton:hover{background:red;}''')
        self.left_visit.setStyleSheet(
            '''QPushButton{background:#6DDF6D;border-radius:20px;}QPushButton:hover{background:blue;}''')
        ...
        self.setWindowIcon(QIcon('F:/picture/4.jpg'))
        ...
        self.wenben.setStyleSheet("QLabel{background:black;}"
                                  "QLabel{color:white;font-size:35px;font-weight:white;font-family:宋体;}"
                                  )
        ...
        self.wenben1.setStyleSheet("QLabel{background:grey;}"
                                  "QLabel{color:white;font-size:20px;font-weight:white;font-family:宋体;}"
                                  )
        ...
        self.wenben4.setStyleSheet("QLabell{background-color:rgb(185,185,185);}"
                                   "QLabel{color:white;font-size:20px;font-weight:white;font-family:宋体;}"
                                   )
    ...
    def openimage(self):
        ...
        chose_dir = QFileDialog.getExistingDirectory(self, '选取文件夹', os.getcwd())
        print('选取的文件夹为：')
        print(chose_dir)
        print('\n')
    ...
    def detectimage(self):
        ...
        # #           (182, 194, 154), (138, 151, 123), (244, 208, 0), (229, 131, 8), (220, 87, 18),
        # #           (130, 57, 53), (137, 190, 178), (201, 186, 131), (222, 211, 140), (222, 156, 83)]
        ...
        self.wenben5.setStyleSheet("QLabel{color:white;font-size:15px;font-weight:white;font-family:宋体;}")
        self.wenben6.setText(concat)
        self.wenben6.setGeometry(1115, 180, 400, 200)
        self.wenben6.setStyleSheet("QLabel{color:white;font-size:15px;font-weight:white;font-family:宋体;}")
    ...
    #     global img_cv
    #
    #     input_image_cp = img_cv  # 输入图像的副本
    #
    #     pixels_value_max = np.max(input_image_cp)  # 输入图像像素的最大值
    #
    #     output_imgae = pixels_value_max - input_image_cp  # 输出图像
    #     img_ = output_imgae.astype("uint8")
    #     img_ = cv.cvtColor(img_, cv.COLOR_BGR2RGB)
    #     img_ = Image.fromarray(img_)
    #     img_ = img_.toqpixmap()
    #
    #     img_ = QtGui.QPixmap(img_).scaled(self.label2.width(), self.label2.height())
    #     self.label2.setPixmap(img_)
